...
<head>
  ...
  <title>Perpustakaan Moklet | Log in</title>
...
<div class="login-box">
  <div class="login-logo">
    <a href="<?=base_url()?>home/login"><b>Perpustakaan</b> Moklet</a>
  </div>
  ...
  <div class="login-box-body">
    ...
    <!-- /.social-auth-links -->
    <br>
    Belum Punya Akun ?<a href="<?=base_url()?>admin/register" class="text-center"> Daftar Disini</a>
