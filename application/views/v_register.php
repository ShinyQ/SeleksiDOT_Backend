...
<div class="register-box">
  <div class="register-logo">
    <a href="<?=base_url()?>home/register"><b>Perpustakaan </b> Moklet</a>
  </div>
  ...
  <div class="register-box-body">
    ...
    <form action="<?=base_url('admin/register_akun')?>" method="post">
    ...
    <br>
    Saya Sudah Punya Akun ? <a href="<?=base_url()?>admin/login" class="text-center">Login</a>
  </div>
  <!-- /.form-box -->
</div>
<!-- /.register-box -->
